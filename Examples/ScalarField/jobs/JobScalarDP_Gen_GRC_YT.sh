...
source CSD3-Icelake-Intel-modules.sh

#! Insert additional module load commands after this line if needed:

#! Full path to application executable: 
application="~/rds/rds-dirac-dp002/yl844/myGRTeclyn/Examples/ScalarField/main3d.gnu.MPI.ex"
...
CMD="srun --distribution=block:block $application $options"
