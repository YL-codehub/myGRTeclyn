...
class MultiSourceCCZ4RHS : public CCZ4RHS<gauge_t, deriv_t>
{
  public:
    ...
    /*!
       ...
       one by default.
    */
    MultiSourceCCZ4RHS(matter_t a_matter, params_t a_params, double a_dx,
  ...
  protected:
    ...
    //! compute()
    template <class data_t>
    AMREX_GPU_DEVICE AMREX_FORCE_INLINE void add_geom_sources_rhs(
...
#include "MultiSourceCCZ4RHS.impl.hpp"

#endif /* MULTISOURCECCZ4RHS_HPP_ */
