...
#if !defined(MULTISOURCECCZ4RHS_HPP_)
#error "This file should only be included through MultiSourceCCZ4RHS.hpp"
#endif

#ifndef MULTISOURCECCZ4RHS_IMPL_HPP_
#define MULTISOURCECCZ4RHS_IMPL_HPP_
#include "DimensionDefinitions.hpp"

template <class matter_t, class gauge_t, class deriv_t>
MultiSourceCCZ4RHS<matter_t, gauge_t, deriv_t>::MultiSourceCCZ4RHS(
...
#endif /* MULTISOURCECCZ4RHS_IMPL_HPP_ */
