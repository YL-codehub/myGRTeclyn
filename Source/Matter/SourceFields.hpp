...
#ifndef SOURCEFIELDS_HPP_
#define SOURCEFIELDS_HPP_
...
*/
template <class potential_t = DefaultPotential> class SourceFields
{
  protected:
  ...
  public:
    ...
    SourceFields(const potential_t a_potential) : my_potential(a_potential) {}
    ...
    template <class data_t> struct Vars
    {
        ...
        AMREX_GPU_DEVICE void enum_mapping(mapping_function_t mapping_function)
        {
            ...
            VarsTools::define_enum_mapping(mapping_function, c_Rlin, Rlin);
        }
    };
    ...
    AMREX_GPU_DEVICE AMREX_FORCE_INLINE void add_sources_rhs(
...
#include "SourceFields.impl.hpp"

#endif /* SOURCEFIELDS_HPP_ */
